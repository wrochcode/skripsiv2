									...
									<div class="we-do-description">
										<div class="we-do-info">
											<div class="we-do-img">
												...
												<img src="{{URL::asset('images/home/consultency.png')}}" alt="image of consultency" />
											</div><!--/.we-do-img-->
									...
									<div class="we-do-description">
										<div class="we-do-info">
											<div class="we-do-img">
												...
												<img src="{{URL::asset('images/home/busisness_grow.png')}}" alt="image of business" />
											</div><!--/.we-do-img-->
											<div class="we-do-topics">
												<h2>
													<a href="#">
									...
									<div class="we-do-description">
										<div class="we-do-info">
											<div class="we-do-img">
												...
												<img src="{{URL::asset('images/home/support-logo.png')}}" alt="image of support" />
											</div><!--/.we-do-img-->
											<div class="we-do-topics">
												<h2>
													<a href="#">
						...
						<div class="col-sm-6">
							<div class="single-about-us">
								<div class="about-us-img">
									...
									<img src="{{URL::asset('images/about/about-part.jpg')}}" alt="image of business" />
								</div><!--/.about-us-img-->
							</div><!--/.single-about-us-->
						</div><!--/.col-->
					</div><!--/.row-->
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										<div class="service-img">
                                            ...
                                            <img src="{{URL::asset('images/service/service1.png')}}" alt="image of business" />
										</div><!--/.service-img-->
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										<div class="service-img">
                                            ...
                                            <img src="{{URL::asset('images/service/service2.png')}}" alt="image of business" />
										</div><!--/.service-img-->
										<div class="service-txt">
											<h2>
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										<div class="service-img">
											...
											<img src="{{URL::asset('images/service/service3.png')}}" alt="image of business" />
										</div><!--/.service-img-->
										<div class="service-txt">
											<h2>
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										<div class="service-img">
                                            ...
                                            <img src="{{URL::asset('images/service/service4.png')}}" alt="image of business" />
										</div><!--/.service-img-->
										<div class="service-txt">
											<h2>
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										<div class="service-img">
                                            ...
                                            <img src="{{URL::asset('images/service/service5.png')}}" alt="image of business" />
										</div><!--/.service-img-->
										<div class="service-txt">
											<h2>
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										<div class="service-img">
                                            ...
                                            <img src="{{URL::asset('images/service/service6.png')}}" alt="image of business" />
										</div><!--/.service-img-->
										<div class="service-txt">
											<h2>
					...
					<div class="col-md-3 col-sm-6">
						<div class="single-ststistics-box">
							<div class="statistics-img">
								...
								<img src="{{URL::asset('images/counter/counter1.png')}}" alt="image of business" />
							</div><!--/.statistics-img-->
					...
					<div class="col-md-3 col-sm-6">
						<div class="single-ststistics-box">
							<div class="statistics-img">
                                ...
                                <img src="{{URL::asset('images/counter/counter2.png')}}" alt="image of business" />
							</div><!--/.statistics-img-->
							<div class="statistics-content">
					...
					<div class="col-md-3 col-sm-6">
						<div class="single-ststistics-box">
							<div class="statistics-img">
                                ...
                                <img src="{{URL::asset('images/counter/counter3.png')}}" alt="image of business" />
							</div><!--/.statistics-img-->
							<div class="statistics-content">
					...
					<div class="col-md-3 col-sm-6">
						<div class="single-ststistics-box">
							<div class="statistics-img">
                                ...
                                <img src="{{URL::asset('images/counter/counter4.png')}}" alt="image of business" />
							</div><!--/.statistics-img-->
							<div class="statistics-content">
								...
								<div class="row">
									<div class=" col-md-4 col-sm-12">
										<div class="item big-height">
											...
											<img src="{{URL::asset('images/project/project1.jpg')}}" alt="image of business" />
										...
										<div class="row">
											<div class="col-sm-6 col-xs-12">
												<div class="item">
													...
													<img src="{{URL::asset('images/project/project2.jpg')}}" alt="image of business" />
													<div class="isotope-overlay">
														<a href="project.html">
															<span class="lnr lnr-link"></span>
											...
											<div class="col-sm-6 col-xs-12">
												<div class="item">
                                                    ...
                                                    <img src="{{URL::asset('images/project/project3.jpg')}}" alt="image of business" />
													<div class="isotope-overlay">
														<a href="project.html">
															<span class="lnr lnr-link"></span>
										...
										<div class="row">
											<div class="col-sm-6 col-xs-12">
												<div class="item">
                                                    ...
                                                    <img src="{{URL::asset('images/project/project4.jpg')}}" alt="image of business" />
													<div class="isotope-overlay">
														<a href="project.html">
															<span class="lnr lnr-link"></span>
											...
											<div class="col-sm-6 col-xs-12">
												<div class="item">
													...
													<img src="{{URL::asset('images/project/project5.jpg')}}" alt="image of business" />
													<div class="isotope-overlay">
														<a href="project.html">
															<span class="lnr lnr-link"></span>
					...
					<div class="owl-carousel owl-theme" id="client">
						<div class="item">
							<a href="#">
                                ...
                                <img src="{{URL::asset('images/client/client1.png')}}" alt="image of business" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								{{-- <img src="assets/images/client/client2.png" alt="brand-image" /> --}}
                                <img src="{{URL::asset('images/client/client2.png')}}" alt="image of business" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								{{-- <img src="assets/images/client/client3.png" alt="brand-image" /> --}}
                                <img src="{{URL::asset('images/client/client3.png')}}" alt="image of business" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								{{-- <img src="assets/images/client/client4.png" alt="brand-image" /> --}}
                                <img src="{{URL::asset('images/client/client4.png')}}" alt="image of business" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								{{-- <img src="assets/images/client/client5.png" alt="brand-image" /> --}}
                                <img src="{{URL::asset('images/client/client5.png')}}" alt="image of business" />
							</a>
						</div><!--/.item-->
					</div><!--/.owl-carousel-->
				</div><!--/.clients-area-->
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-news-box">
										<div class="news-box-bg">
                                            ...
                                            <img src="{{URL::asset('images/blog/bl1.jpg')}}" alt="image of business" />
											<div class="isotope-overlay">
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-news-box">
										<div class="news-box-bg">
                                            ...
                                            <img src="{{URL::asset('images/blog/bl2.jpg')}}" alt="image of business" />
											<div class="isotope-overlay">
												<a href="blog_single.html">
													<span class="lnr lnr-link"></span>
								...
								<div class="col-md-4 col-sm-6">
									<div class="single-news-box">
										<div class="news-box-bg">
                                            ...
                                            <img src="{{URL::asset('images/blog/bl3.jpg')}}" alt="image of business" />
											<div class="isotope-overlay">
												<a href="blog_single.html">
													<span class="lnr lnr-link"></span>
