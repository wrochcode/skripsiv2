                ...
                <div class="col-lg-12 col-sm-12 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-block text-center p-3" href="">
                        <div class="p-4">
                            ...
                            <h4><a href="{{ route('calchealth') }}">Kalkulator</a> Karbohidrat</h4>
                            <span>Mengestimasi berapa gram karbohidrat yang perlu anda konsumsi untuk menjaga pola makan sehat.</span>
                            <form class="grid text-center mt-5" style="--bs-rows: 3; --bs-columns: 3;" action="{{ route('carb.store') }}" method="post">
                                @csrf
