                                ...
                                <div class="blogs-widget">
                                    ...
                                    <div class="blog-related-news">
                                        <div class="bl-txt wow fadeInUp" data-wow-duration=".7s" data-wow-delay=".7s">
                                            <div class="bl-img">
                                                <a href="#">
                                                    ...
                                                    <img src="{{URL::asset('images/blog/rp1.jpg')}}" alt="blog image">
                                                </a>
                                            </div>
                                            <!--/.bl-img-->
                                            <p>
                                        ...
                                        <div class="bl-txt">
                                            <div class="bl-img">
                                                <a href="#">
                                                    <img src="{{URL::asset('images/blog/rp2.jpg')}}" alt="blog image">
                                                </a>
                                            </div>
                                            <!--/.bl-img-->
                                            <p>
                                        ...
                                        <div class="bl-txt">
                                            <div class="bl-img">
                                                <a href="#">
                                                    <img src="{{URL::asset('images/blog/rp3.jpg')}}" alt="blog image">
                                                </a>
                                            </div>
                                            <!--/.bl-img-->
                                            <p>
