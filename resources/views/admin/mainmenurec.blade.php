            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4 col-xl-5">
                        ...
                        <div class="card-body">
                            <form action="{{ route('foodmenurec.store') }}" style="margin-bottom: 20px" method="post">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-md-9">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-1">
                                    <div class="form-floating mb-3 ">
                                        <a href="{{ route('foodmenurec.full') }}"class="btn btn-primary mt-2" type="submit">Lihat Semua</a>
                                    </div>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-xl-12 col-md-6">
                                ...
                                @endif
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            ...
                                            <a class="btn btn-danger" href="{{ route('foodmenurec.destroy', $foods[$i]['id']) }}">Hapus <i class="fa fa-trash" aria-hidden="true"></i></button></a>
                                    </div>
                                </div>
                                @php
                                    // echo $indexloop;
